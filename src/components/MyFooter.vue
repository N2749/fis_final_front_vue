            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="infpart linkspart">
                        ...
                        <p><strong>Company:</strong> Happy Angel<br><br>
...
<template>
  <footer class="footer">
    <div class="footer__container">
      <div class="footer__info layout-4-column">
        <div class="footer__about">
          <h4 class="footer__title">about us</h4>

          <p class="footer__about">
            On&nbsp;Bus Ticket Kz&nbsp;you can buy e-tickets <br />

            for buses without leaving your home
          </p>
        </div>
        ...
        <div class="footer__links">
          ...
          <ul class="list">
            ...
            <li class="list__item">
              <a href="#" class="list__link">Tracking</a>
            </li>

            <li class="list__item">
              <a href="#" class="list__link">Schedule</a>
            </li>

            <li class="list__item"><a href="#" class="list__link">Help</a></li>
          </ul>
        </div>
        ...
        <div class="footer__questions">
          ...
          <ul class="list">
            ...
            <li class="list__item">
              <a href="#" class="list__link">How to use the site</a>
            </li>

            <li class="list__item">
              <a href="#" class="list__link">What is an e-ticket</a>
            </li>

            <li class="list__item">
              <a href="#" class="list__link">How to refund</a>
            </li>
          </ul>
        </div>
          ...
          <ul class="list">
            ...
            <li class="list__item">
              <span class="contact__info"
                >Address: Kazakhstan, Almaty, Abay, XXX</span
              >
            </li>

            <li class="list__item">
              <span class="contact__info">
                Contact Number: +7 (700) 000 00 01
              </span>
            </li>
      ...
      <h5 class="copyright">Copyright &copy;&nbsp;2022.All rights reserved.</h5>
    </div>
  </footer>
</template>
